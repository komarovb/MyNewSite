    ...
    <div class="wrap">
    	<div class="content">
    	   <div class="admin-form">
                    ...
                    <form action="php/admin.php" class="adform" id="adf">
                        <p class="flabel">Логин</p>
                        <input type="text" class="admin-input add-input" placeholder="Введите логин">
                        <p class="flabel">Пароль</p>
                        <input type="password" class="admin-input add-input" placeholder="Введите пароль">
